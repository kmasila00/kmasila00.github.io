        ...
        <MediaQuery query='(max-device-width:450px)'>
          <div style={styles.panelSize} className="list-group">
            <div style={styles.panelBox} className="list-group-item">
              <h4 style={styles.MQlistHeading} className="list-group-item-heading">Your Favorite Team Sucks</h4>
              <p style={styles.MQeduNameStyle} className="list-group-item-text">August 2016 - September 2016</p>
              <p style={styles.MQeduTextStyle} className="list-group-item-text">● Sole Developer</p>
              <p style={styles.MQeduTextStyle} className="list-group-item-text">● A Fantasy Football informational site
              ...
              <p style={styles.MQeduTextStyle} className="list-group-item-text">● All rankings and articles are
              ...
              <p style={styles.MQeduTextStyle} className="list-group-item-text">● Website -
                <a style={styles.MQeduTextStyle} target="_blank" href="http://yourfavoriteteamsucks.com" >
