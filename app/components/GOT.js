        ...
        <MediaQuery query='(max-device-width:450px)'>
          <div style={styles.panelSize} className="list-group">
            <div style={styles.panelBox} className="list-group-item">
              <h4 style={styles.MQlistHeading} className="list-group-item-heading">Welcome to the Game of Thrones</h4>
              <p style={styles.MQeduNameStyle} className="list-group-item-text">June 2016</p>
              <p style={styles.MQeduTextStyle} className="list-group-item-text">● Sole Developer</p>
              <p style={styles.MQeduTextStyle} className="list-group-item-text">● Trivia app that tests your knowledge
                of Game of Thrones at varying difficulty levels</p>
              <p style={styles.MQeduTextStyle} className="list-group-item-text">● Used Postgres database to store and
                access scores and rankings against other players</p>
              <p style={styles.MQeduTextStyle} className="list-group-item-text">● Created using Sequelize, Express,
                Angular, Node, HTML/CSS</p>
              <p style={styles.MQeduTextStyle} className="list-group-item-text">● GitHub Repo -
                <a style={styles.MQeduTextStyle} target="_blank" href="https://github.com/kmasila00/Got-Trivia" >
