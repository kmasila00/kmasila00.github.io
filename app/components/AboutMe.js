    ...
    return (
        <div className="list-group">
          <a style={this.props.format.aboutMeBox} className="list-group-item">
            <h4 style={this.props.format.listHeading} className="list-group-item-heading">About Me</h4>
            <p style={this.props.format.textStyle} className="list-group-item-text">
            ...
            </p> <br/> <p style={this.props.format.textStyle} className="list-group-item-text">
